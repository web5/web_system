# .codebuddy/references/ · 项目级规范与流程

本目录放**本项目专属**的规范与流程文档（与具体工程实现绑定的那一类）；通用方法论（常驻总则 / 红线 / references）在**上游仓库** `https://github.com/web5/ai-agent-kit`（本地只留声明 `../agent-kit/README.md`），技能实体在 `../skills/`。

| 内容 | 去哪 |
|---|---|
| agent 相关规则（含工程安全规则） | `../rules/` |
